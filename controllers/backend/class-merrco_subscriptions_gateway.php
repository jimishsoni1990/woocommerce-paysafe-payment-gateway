<?php
/**
 * Merrco Subscription Gateway
 *
 * Provides a Merrco Payment Gateway for Subscriptions.
 *
 * @class       Merrco_Subscriptions_Gateway
 * @extends     Merrco_Gateway_Init
 * @package     WooCommerce/Classes/Payment
 */

if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly

class Merrco_Subscriptions_Gateway extends Merrco_Gateway_Init {
        ...
        $i++;
         ...
         if(!empty($listcard)){
                   ...
                   foreach($listcard as $cards) {
                       $tokenKeyId=$cards[0]['merrco_tokenno'];
                   }
                ...
                $merrco_request=$merrco_request_object->get_request_merrco_url_token($merrcoApiKeyId, $merrcoApiKeySecret, $merrcoAccountNumber, $environment, $totalAmount, $currencyBaseUnitsMultiplier, $tokenKeyId, $authCaptureSettlement, $corder_id);
                ...
                if($merrco_request['responsecode']=='0'){
                    ...
                    return true; 
                     ...
                     update_post_meta( $order->get_id(), '_merrco_status_error', $errormessage );
                      return false; 
                  }
    ...
    protected function payment_failed_save_cards() {
        $this->order->add_order_note(
            sprintf(
                __( 'Save Card Not found for this User', 'mer-merrcopayments-aim' ),
                get_class( $this ),
